            ...
            if len(results) == 2:
                if results[0].status_code != results[1].status_code:
                    ...
                    finding = Finding(
                        ...
                        param=param, payload="check-then-use sequence",
                ...
                if success_count > 1:
                    ...
                    if len(unique_statuses) > 1:
                        ...
                        finding = Finding(
                            ...
                            url=url, severity='HIGH', confidence=0.6,
            ...
            if len(responses) >= 2:
                ...
                if max(lengths) - min(lengths) > 100:
                    ...
                    finding = Finding(
                        ...
                        url=url, severity='LOW', confidence=0.4,
                        param='N/A', payload=f"{num_concurrent} concurrent GETs",
