...
CVE_DATABASE = [
    {
        ...
        'tech': 'PHP', 'min_ver': '8.1.0', 'max_ver': '8.3.8',
        'cvss': 9.8, 'description': 'PHP CGI argument injection (Windows)',
        'endpoint_hint': '/cgi-bin/',
    },
    {
        'cve_id': 'CVE-2023-22515',
        'tech': 'Confluence', 'min_ver': '8.0.0', 'max_ver': '8.5.1',
        'cvss': 10.0, 'description': 'Atlassian Confluence broken access control',
        'endpoint_hint': '/setup/',
    },
    {
        'cve_id': 'CVE-2023-44487',
        'tech': 'HTTP/2', 'min_ver': '', 'max_ver': '',
        'cvss': 7.5, 'description': 'HTTP/2 Rapid Reset DDoS',
        'endpoint_hint': '',
    },
    {
        'cve_id': 'CVE-2023-46604',
        'tech': 'Apache ActiveMQ', 'min_ver': '5.0.0', 'max_ver': '5.18.3',
        'cvss': 10.0, 'description': 'Apache ActiveMQ RCE',
        'endpoint_hint': ':61616',
    },
    {
        'cve_id': 'CVE-2024-21887',
        'tech': 'Ivanti Connect Secure', 'min_ver': '', 'max_ver': '',
        'cvss': 9.1, 'description': 'Ivanti Connect Secure command injection',
        'endpoint_hint': '/api/v1/totp/user-backup-code',
    },
    {
        'cve_id': 'CVE-2023-50164',
        'tech': 'Apache Struts', 'min_ver': '2.0.0', 'max_ver': '6.3.0',
        'cvss': 9.8, 'description': 'Apache Struts path traversal RCE',
        'endpoint_hint': '/upload',
    },
    {
        'cve_id': 'CVE-2024-23897',
        'tech': 'Jenkins', 'min_ver': '', 'max_ver': '2.442',
        'cvss': 9.8, 'description': 'Jenkins arbitrary file read',
        'endpoint_hint': '/cli',
    },
    {
        'cve_id': 'CVE-2021-44228',
        'tech': 'Log4j', 'min_ver': '2.0.0', 'max_ver': '2.17.0',
        'cvss': 10.0, 'description': 'Log4Shell RCE via JNDI injection',
        'endpoint_hint': '',
    },
    {
        'cve_id': 'CVE-2023-3519',
        'tech': 'Citrix NetScaler', 'min_ver': '', 'max_ver': '',
        'cvss': 9.8, 'description': 'Citrix NetScaler ADC RCE',
        'endpoint_hint': '/vpn/',
    },
    {
        'cve_id': 'CVE-2023-27997',
        'tech': 'FortiGate', 'min_ver': '', 'max_ver': '',
        'cvss': 9.8, 'description': 'FortiOS SSL VPN heap overflow',
...
class IntelligenceEnricher:
    ...
    def run(self, responses: List = None, params: List = None,
            urls: Set = None) -> IntelligenceBundle:
