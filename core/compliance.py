...
OWASP_TOP_10 = {
    'A01': {
        ...
        'keywords': ['idor', 'access control', 'privilege', 'authorization',
                     'cors', 'csrf', 'directory traversal', 'path traversal'],
    },
    'A02': {
        'id': 'A02:2021',
        'name': 'Cryptographic Failures',
        'cwe_ids': ['CWE-261', 'CWE-296', 'CWE-310', 'CWE-319', 'CWE-321',
                    'CWE-322', 'CWE-323', 'CWE-324', 'CWE-325', 'CWE-326',
                    'CWE-327', 'CWE-328', 'CWE-329', 'CWE-330', 'CWE-331'],
        'keywords': ['crypto', 'ssl', 'tls', 'certificate', 'weak cipher',
                     'plaintext', 'encryption', 'jwt'],
    },
    'A03': {
        'id': 'A03:2021',
        'name': 'Injection',
        'cwe_ids': ['CWE-20', 'CWE-74', 'CWE-75', 'CWE-77', 'CWE-78',
                    'CWE-79', 'CWE-80', 'CWE-83', 'CWE-87', 'CWE-88',
                    'CWE-89', 'CWE-90', 'CWE-91', 'CWE-93', 'CWE-94',
                    'CWE-95', 'CWE-96', 'CWE-97', 'CWE-98', 'CWE-99',
                    'CWE-113', 'CWE-116', 'CWE-138', 'CWE-184'],
        'keywords': ['sql injection', 'sqli', 'xss', 'cross-site scripting',
                     'command injection', 'cmdi', 'ldap injection', 'nosql',
                     'ssti', 'xxe', 'crlf', 'header injection', 'template injection'],
    },
    'A04': {
        'id': 'A04:2021',
        'name': 'Insecure Design',
        'cwe_ids': ['CWE-73', 'CWE-183', 'CWE-209', 'CWE-213', 'CWE-235',
                    'CWE-256', 'CWE-257', 'CWE-266', 'CWE-269', 'CWE-280',
                    'CWE-311', 'CWE-312', 'CWE-313', 'CWE-316', 'CWE-419',
                    'CWE-430', 'CWE-434', 'CWE-444', 'CWE-451', 'CWE-472'],
        'keywords': ['design flaw', 'business logic', 'race condition',
                     'file upload', 'insecure design'],
    },
    'A05': {
        'id': 'A05:2021',
        ...
        'cwe_ids': ['CWE-2', 'CWE-11', 'CWE-13', 'CWE-15', 'CWE-16',
                    ...
                    'CWE-541', 'CWE-547'],
        'keywords': ['misconfiguration', 'default', 'missing header',
                     'security header', 'directory listing', 'verbose error',
    ...
    'A06': {
        ...
        'cwe_ids': ['CWE-1104'],
        'keywords': ['outdated', 'vulnerable component', 'cve', 'tech exploit',
                     'network exploit', 'version', 'unpatched'],
    },
    'A07': {
        'id': 'A07:2021',
        'name': 'Identification and Authentication Failures',
        'cwe_ids': ['CWE-255', 'CWE-259', 'CWE-287', 'CWE-288', 'CWE-290',
    ...
    'A08': {
        ...
        'keywords': ['deserialization', 'prototype pollution', 'integrity',
                     'supply chain', 'unsigned'],
    },
    'A09': {
        'id': 'A09:2021',
...
# ---------------------------------------------------------------------------
PCI_DSS = {
    'R1': {'id': '1', 'name': 'Install and Maintain Network Security Controls',
            'keywords': ['firewall', 'network', 'port scan', 'segmentation']},
    'R2': {'id': '2', 'name': 'Apply Secure Configurations',
            'keywords': ['default', 'misconfiguration', 'hardening', 'security header']},
    'R3': {'id': '3', 'name': 'Protect Stored Account Data',
            'keywords': ['data exposure', 'database', 'dump', 'encryption', 'storage']},
    'R4': {'id': '4', 'name': 'Protect Cardholder Data with Strong Cryptography',
            'keywords': ['ssl', 'tls', 'crypto', 'certificate', 'plaintext']},
    'R5': {'id': '5', 'name': 'Protect Against Malicious Software',
            'keywords': ['malware', 'shell', 'upload', 'webshell']},
    'R6': {'id': '6', 'name': 'Develop and Maintain Secure Systems and Software',
            'keywords': ['sqli', 'xss', 'injection', 'vulnerability', 'cve', 'patch']},
    'R7': {'id': '7', 'name': 'Restrict Access to System Components',
            'keywords': ['access control', 'authorization', 'idor', 'privilege']},
    'R8': {'id': '8', 'name': 'Identify Users and Authenticate Access',
            'keywords': ['authentication', 'brute force', 'password', 'mfa', 'jwt']},
    'R10': {'id': '10', 'name': 'Log and Monitor All Access',
             'keywords': ['logging', 'monitoring', 'audit trail']},
    'R11': {'id': '11', 'name': 'Test Security of Systems and Networks Regularly',
             'keywords': ['scan', 'penetration test', 'assessment']},
    'R12': {'id': '12', 'name': 'Support Information Security with Policies',
...
# ---------------------------------------------------------------------------
NIST_800_53 = {
    'AC': {'id': 'AC', 'name': 'Access Control',
           'keywords': ['access control', 'authorization', 'idor', 'cors', 'privilege']},
    'AU': {'id': 'AU', 'name': 'Audit and Accountability',
           'keywords': ['audit', 'logging', 'monitoring']},
    'CA': {'id': 'CA', 'name': 'Assessment, Authorization, and Monitoring',
           'keywords': ['scan', 'assessment', 'monitoring', 'vulnerability']},
    'CM': {'id': 'CM', 'name': 'Configuration Management',
           'keywords': ['misconfiguration', 'default', 'hardening', 'security header']},
    'IA': {'id': 'IA', 'name': 'Identification and Authentication',
           'keywords': ['authentication', 'brute force', 'password', 'jwt', 'session']},
    'RA': {'id': 'RA', 'name': 'Risk Assessment',
           'keywords': ['vulnerability', 'cve', 'risk', 'severity', 'cvss']},
    'SC': {'id': 'SC', 'name': 'System and Communications Protection',
           'keywords': ['encryption', 'ssl', 'tls', 'ssrf', 'injection', 'xss']},
    'SI': {'id': 'SI', 'name': 'System and Information Integrity',
...
# ---------------------------------------------------------------------------
CIS_CONTROLS = {
    'CIS-1': {'id': '1', 'name': 'Inventory and Control of Enterprise Assets',
              'keywords': ['discovery', 'asset', 'subdomain', 'port scan']},
    'CIS-2': {'id': '2', 'name': 'Inventory and Control of Software Assets',
              'keywords': ['tech detect', 'software', 'version', 'component']},
    'CIS-3': {'id': '3', 'name': 'Data Protection',
              'keywords': ['data exposure', 'encryption', 'dump', 'plaintext']},
    'CIS-4': {'id': '4', 'name': 'Secure Configuration',
              'keywords': ['misconfiguration', 'default', 'hardening', 'security header']},
    'CIS-5': {'id': '5', 'name': 'Account Management',
              'keywords': ['authentication', 'password', 'brute force', 'credential']},
    'CIS-7': {'id': '7', 'name': 'Continuous Vulnerability Management',
              'keywords': ['vulnerability', 'cve', 'scan', 'patch', 'exploit']},
    'CIS-8': {'id': '8', 'name': 'Audit Log Management',
              'keywords': ['audit', 'logging', 'monitoring']},
    'CIS-9': {'id': '9', 'name': 'Email and Web Browser Protections',
              'keywords': ['xss', 'phishing', 'open redirect', 'csp']},
    'CIS-10': {'id': '10', 'name': 'Malware Defenses',
               'keywords': ['malware', 'shell', 'upload', 'webshell']},
    'CIS-16': {'id': '16', 'name': 'Application Software Security',
...
class ComplianceEngine:
    ...
    def analyze(self, findings: list, scan_id: str = '', target: str = '',
        ...
        for fw_name in frameworks:
            ...
            report.framework_scores[fw_name] = self._score_framework(
                findings, fw_name, fw_controls, report.mappings,
            )
    ...
    def _score_framework(self, findings: list, fw_name: str, controls: dict,
                         all_mappings: List[ComplianceMapping]) -> dict:
        ...
        risk_score = sum(
            severity_weight.get(m.finding_severity, 1) for m in fw_mappings
        )
    ...
    def _gap_analysis(self, mappings: List[ComplianceMapping],
