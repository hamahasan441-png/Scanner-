...
from core.notification import (
    NotificationManager, Notification, ConsoleChannel, WebhookChannel,
    NotifySeverity,
)
...
class TestNotification(unittest.TestCase):
    ...
    def test_to_dict(self):
        n = Notification(
            ...
            channel='console', timestamp='2025-01-01T00:00:00Z',
        )
        d = n.to_dict()
...
class TestWebhookChannel(unittest.TestCase):
    ...
    def test_discord_format(self):
        ...
        n = Notification(title='Alert', message='finding', severity='warning',
                         timestamp='2025-01-01T00:00:00Z')
        payload = ch._format_payload(n)
