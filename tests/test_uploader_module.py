...
class _MockFinding:
    def __init__(self, technique='', url='', param='', payload='',
                 evidence=''):
...
class TestRunRouting(unittest.TestCase):
    ...
    def test_lfi_finding_calls_try_lfi_shell(self, mock_lfi):
        finding = _MockFinding(technique='LFI via traversal',
                               url='http://example.com', param='file')
    ...
    def test_cmdi_finding_calls_try_rce_shell(self, mock_rce):
        finding = _MockFinding(technique='Command Injection',
                               url='http://example.com', param='cmd')
        self.uploader.run([finding], [])
...
class TestFindUploadedShell(unittest.TestCase):
    ...
    def test_finds_shell_url_in_response(self):
        resp = _MockResponse(
            text='<a href="http://example.com/uploads/shell.php">link</a>')
...
class TestVerifyShell(unittest.TestCase):
    ...
    def test_successful_verification(self):
        ...
        try:
            self.assertTrue(
                uploader._verify_shell('http://example.com/uploads/shell.php'))
        finally:
            shutil.rmtree(tmpdir)
